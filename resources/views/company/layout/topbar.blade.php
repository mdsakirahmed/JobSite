    ...
    <nav class="navbar navbar-expand fixed-top gradient-ibiza">
        ...
        <ul class="navbar-nav align-items-center right-nav-link">
            ...
            <li class="nav-item language">
                <a class="nav-link dropdown-toggle dropdown-toggle-nocaret waves-effect" data-toggle="dropdown" href="#">{{ \Illuminate\Support\Facades\Session::get('language') }}</a>
                <ul class="dropdown-menu dropdown-menu-right animated fadeIn">
                    @foreach($languages as $language)
                    <li class="dropdown-item selectedLanguage"> {{ $language->name }}</li>
                    @endforeach
                </ul>
            </li>
            <li class="nav-item">
                <a class="nav-link dropdown-toggle dropdown-toggle-nocaret" data-toggle="dropdown" href="#">
                    <span class="user-profile"><img src="{{ asset('uploads/images/profiles/'.auth()->user()->image) }}" class="img-circle" alt="user avatar"></span>
                </a>
                <ul class="dropdown-menu dropdown-menu-right animated fadeIn">
                    <li class="dropdown-item user-details">
                        <a href="javaScript:void();">
                            <div class="media">
                                <div class="avatar"><img class="align-self-start mr-3" src="{{ asset('uploads/images/profiles/'.auth()->user()->image) }}" alt="user avatar"></div>
                                <div class="media-body">
...
<script>
    $(document).ready(function() {
        ...
        $('.selectedLanguage').click(function(){
            ...
            formData.append('language', $(this).html())
            $.ajax({
                method: 'POST',
                url: "{{ route('languageChanger') }}",
